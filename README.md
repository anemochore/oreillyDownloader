...
- 2023-3-24 v0.0.14 nsp 도서: 목차 수정, css 지원 추가 등등. 이제 좀 제대로 나옴...
- 2023-3-30 v0.0.15 nsp 도서 목차 수정22, css 개선
- 2023-4-18 v0.0.16 팩트 도서 부속 목차 수정, css 수정
- 2023-4-19 v0.0.17 팩트 도서 미주 지원
- 2023-4-19 오라일리 하이퍼링크 평문으로 푸는 애드온 추가
